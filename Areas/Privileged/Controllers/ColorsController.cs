...
namespace ArtDecoMebel.Areas.Privileged
{
    ...
    public class ColorsController : Controller
    {
        ...
        // GET: Privileged/Colors
        public async Task<IActionResult> Index()
        {
            return View(await _context.Colors.ToListAsync());
        }

        // GET: Privileged/Colors/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Privileged/Colors/Create
        ...
        // GET: Privileged/Colors/Delete/5
        ...
        // POST: Privileged/Colors/Delete/5
