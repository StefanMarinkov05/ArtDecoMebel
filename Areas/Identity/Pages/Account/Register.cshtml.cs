    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Създаден е нов акаунт с парола.");
            ...
            // Ако има грешки – презареждаме формата
            return Page();
        }
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("UI изисква потребителско хранилище с поддръжка на имейл.");
            }
